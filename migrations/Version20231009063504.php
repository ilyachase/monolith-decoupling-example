...
final class Version20231009063504 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE delivery (id INT AUTO_INCREMENT NOT NULL, related_order_id INT NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
